        ...
        <x-dropdown align="right" width="48">
          ...
          <x-slot name="content">
            ...
            <form method="POST" action="{{ route('logout') }}">
              @csrf
              <x-dropdown-link class="text-rose-500" :href="route('logout')" onclick="event.preventDefault(); this.closest('form').submit();">
  ...
  <div :class="{ 'block': open, 'hidden': !open }" class="hidden sm:hidden">
    ...
    <div class="pt-4 pb-1 border-t border-gray-700">
      ...
      <div class="mt-3 space-y-1">
        ...
        <form method="POST" action="{{ route('logout') }}">
          @csrf
          <x-responsive-nav-link class="text-rose-500" :href="route('logout')" onclick="event.preventDefault(); this.closest('form').submit();">
            {{ __('Log Out') }}
          </x-responsive-nav-link>
        </form>
      </div>
